(function($) {
    ...
    $.formCreatePdvChild = function(el, options) {
        ...
        base.$el = $(el);
        base.el = el;
        base.$el.data('formCreatePdvChild', base);
    ...
    // $.formCreatePdvChild.defaultOptions = {
    //     buttonStyle: "border: 1px solid #fff; background-color:#000; color:#fff; padding:20px 50px",
    //     buttonPress: function () {}
    // };

    $.fn.formCreatePdvChild = function(options){

        return this.each(function(){

            var bp = new $.formCreatePdvChild(this, options);
