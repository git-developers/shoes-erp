...
class SettingsVariant implements SettingsVariantInterface
{
    ...
    {
        $name = empty($this->getName()) ? $this->getSettings()->getName() : $this->getName();
    ...
    {
        /** @var SettingsVariantTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): SettingsVariantTranslationInterface
    {
        return new SettingsVariantTranslation();
    }
}
