...
class SettingsOptionValue implements SettingsOptionValueInterface
{
    ...
    {
        /** @var SettingsOptionValueTranslationInterface $translation */
     ...
     * {@inheritdoc}
     */
    protected function createTranslation(): SettingsOptionValueTranslationInterface
    {
        return new SettingsOptionValueTranslation();
    }
}
